...
names in [`actionlint.yaml` configuration file](/config) to let actionlint know them.
...
[Installation](/install) | [Usage](/usage) | [Configuration](/config) | [Go API](/api) | [References](/reference)
